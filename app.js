...
io.sockets.on('connection', function(socket) {
    ...
    socket.on('adduser', function(username) {
        ...
        socket.emit('updatechat', 'сервер', 'вы в чате');
        socket.broadcast.emit('updatechat', 'сервер', username + ' присоединился');
    ...
    socket.on('disconnect', function() {
        ...
        io.sockets.emit('updateusers', usernames);
        socket.broadcast.emit('updatechat', 'сервер', socket.username + ' покинул беседу');
    });
